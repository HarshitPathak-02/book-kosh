...
const boughtBooksSchema = new mongoose_1.Schema({
...
const BoughtBook = mongoose_1.default.models.BoughtBook || mongoose_1.default.model("BoughtBook", boughtBooksSchema);
exports.default = BoughtBook;
